 ...
 * Source: librdkafka CONFIGURATION.md (librdkafka 2.15.0), via
...
export type ProducerGlobalConfig = GlobalConfig & {
  /**
...
export type ConsumerGlobalConfig = GlobalConfig & {
  /**
...
export type ProducerTopicConfig = TopicConfig & {
  /**
...
export type ConsumerTopicConfig = TopicConfig & {
  /**
...
export const LIBRDKAFKA_CONFIG_VERSION = "2.15.0";
